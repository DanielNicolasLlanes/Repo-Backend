...
package com.porfolioDanielLlanes.demo.Security.Controller;
//Importaciones de clases:
import com.porfolioDanielLlanes.demo.Security.Dto.JwtDto;
import com.porfolioDanielLlanes.demo.Security.Dto.LoginUsuario;
import com.porfolioDanielLlanes.demo.Security.Dto.NuevoUsuario;
...
import com.porfolioDanielLlanes.demo.Security.Service.RolService;
import com.porfolioDanielLlanes.demo.Security.Service.UsuarioService;
import com.porfolioDanielLlanes.demo.Security.jwt.JwtProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        User usuario = new User(nuevoUsuario.getNombre(), nuevoUsuario.getNombreUsuario(), nuevoUsuario.getAbout(),
